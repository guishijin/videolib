...
//  if (fPasswordIsMD5)
//  {
//    strncpy_s(ha1Buf, 33, password(), 32);
//    ha1Buf[32] = '\0'; // just in case
//  }
//  else
//  {
//    unsigned int const ha1DataLen = (unsigned int )(strlen(username()) + 1
...
//  }
//
//  unsigned int const ha2DataLen = (unsigned int)(strlen(cmd) + 1 + strlen(url));
...
//  delete[] ha2Data;
//
//  unsigned int const digestDataLen
//    = (unsigned int)(32 + 1 + strlen(nonce()) + 1 + 32);
